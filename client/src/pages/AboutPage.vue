...
<template>
  <div class="max-w-3xl mx-auto px-3 sm:px-4 lg:px-6 py-6 md:py-8">
    ...
    <div v-else>
      <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">关于</h1>
      <div class="bg-white rounded-lg shadow-sm border p-4 md:p-8 prose max-w-none" v-html="md.render(aboutContent)"></div>
